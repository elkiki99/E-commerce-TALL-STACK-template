<div class="flex flex-wrap p-10">
    @foreach ($products as $product)
        <div wire:key="{{ $product->id }}" class="flex flex-col w-full mb-4 sm:p-2 md:w-1/2 lg:w-1/3 xl:w-1/4">
                    ...
                    <div class="mt-2">
                        @guest
                            <div class="flex flex-row">
                                ...
                                <button type="button" wire:click="$dispatch('showAddToCart', {{$product->id}})" class="ml-auto md:w-auto">
