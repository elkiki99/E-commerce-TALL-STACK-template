                            ...
                            <div class="flex flex-1 mx-5 mb-4">
                                ...
                                <div class="flex">
                                    <div class="flex items-center ml-2">
                                        ...
                                        <div class="flex items-center">
                                        <button type="button" class="mr-2" x-on:click.prevent="$dispatch('open-modal', 'delete-product-{{ $product->id }}')">
                                        ...
                                        <x-modal name="delete-product-{{ $product->id }}" :show="$errors->isNotEmpty()" focusable>
