<div class="xl:flex md:flex">
    <div class="md:w-1/2">
        <img class="object-contain w-full h-full" loading="lazy" src="{{ asset('storage/img/products/' . $product->image )}}" alt="{{$product->name}}">
    </div>
    <div class="flex flex-col justify-between p-4 md:w-1/2">
        <div>
            ...
            <p class="mt-4 text-xl text-gray-600">
                <a wire:navigate href="{{route('categories.show', ['category' => $category->id])}}">
                    {{ $category->category }}
                </a>
            </p>
