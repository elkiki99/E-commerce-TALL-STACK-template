...
>
    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" 
             ...
             stroke-width="1" 
             stroke="currentColor" 
             class="absolute z-10 w-6 h-6 ml-auto mr-2 transition-transform duration-200 transform hover:scale-125 right-2 top-2">
        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center">
            ...
            <div x-cloak 
                ...
                <div class="flex items-center justify-between space-x-4">
                    <h1 class="text-xl font-medium text-gray-800">Product Added!</h1>
                ...
                <div class="mt-4">
                    <a href="{{ route('likes.index') }}" class="text-indigo-500 hover:underline">View liked products</a>
                </div>
            </div>
        </div>
    </div>
