<form class="pb-10 space-y-5 md:w-1/2" novalidate wire:submit.prevent='createTag'>
    ...
    <div class="mt-4">
        ...
        class="block w-full h-24 px-3 py-2 mt-1 placeholder-gray-700 transition duration-150 ease-in-out border border-gray-300 rounded-md appearance-none dark:placeholder-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm sm:leading-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600"></textarea>
