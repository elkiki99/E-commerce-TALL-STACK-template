<footer class="px-5 bg-gradient-to-r from-indigo-200 via-yellow-200 to-emerald-200 dark:bg-gradient-to-r dark:from-gray-700 dark:via-gray-800 dark:to-gray-900">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col justify-between md:flex-row">
            ...
            <div class="flex flex-col space-y-4 md:space-y-6">
                <h2 class="mt-5 text-lg font-semibold text-gray-800 md:mt-0 dark:text-gray-100">Quick Links</h2>
            ...
            <!-- Column 3 -->
            <div class="flex flex-col space-y-4 md:space-y-6">
                <h2 class="mt-5 text-lg font-semibold text-gray-800 md:mt-0 dark:text-gray-100">Resources</h2>
                <ul class="mt-2 space-y-2">
                    <li>
